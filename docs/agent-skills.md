...
| الأهداف والتنفيذ | OKR Engine | `engine/okr.py` + أمر `/okr` من تيليجرام | ✅ جديدة — جاهزة لقرار الغد |
| الصحة والطاقة | Health Guardian | `prompts/health.md` + `energy_log` + «طاقة N إرهاق M» من تيليجرام | ✅ جديدة — مراقبة الإرهاق أسبوعيًا |
| المال الموسع | Finance E-S-B-I | مربعات الدخل + 7 بنود يوليو الفعلية بالمراجعة | ✅ ترقية |
...
مغطى بالكامل: 10/12 (بعد OKR والصحة والمال الموسع) (Executive، Knowledge، Projects، Rehab، Clinical، Research، Communication، Business جزئي، Safety)
